# MedTRx EPD v1.0.3: 2.13" NFC E-Paper Programmer
...
- **High-Visibility Bold Typography & 2D Auto-Scaling**:
  - Dynamically auto-scales up to 48pt–64pt Bold with 2D width/height boundary fitting, making room/bed numbers (e.g., "501-A") prominent and easy to read from a distance in clinical environments.
