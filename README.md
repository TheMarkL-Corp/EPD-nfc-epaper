...
This repository contains the active development codebase and deployable portable release packages for the **MedTRx EPD (v1.0.2)** 2.13" NFC E-Paper Programmer application.
...
│   ├── MedTRx_EPD.exe                     # Compiled development executable (v1.0.2)
...
- For distribution to end users, share [`MedTRx_EPD_v1.0.2_Portable.zip`](./02_DEPLOYED_PACKAGE/MedTRx_EPD_v1.0.2_Portable.zip).
